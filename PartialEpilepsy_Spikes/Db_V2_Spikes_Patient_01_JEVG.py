...
event_channels = [
    ("P4", "O2"), ("P4", "O2"), ("P4", "O2"), ("P4", "O2"), ("P4", "O2"),
    ("P4", "O2"), ("P4", "O2"), ("P4", "O2"), ("C4", "P4"), ("T3", "T5")
]
...
base_folder = Path("MonoEEG_Patient_1_Spikes_JEVG")
index = 1
...
fif_filename = current_folder / "MonoEEG_Patient_1_Spikes_JEVG_raw.fif"
...
txt_filename = current_folder / "MonoEEG_Patient_1_Spikes_JEVG_text.txt"
...
edf_filename = current_folder / "MonoEEG_Patient_1_Spikes_JEVG_EegFormat.edf"
...
for i in range(10):
    ...
    fig.savefig(current_folder / f'MonoEEG_Pat_1_Sp_JEVG_segment_{i+1}.jpg')
    plt.close(fig)