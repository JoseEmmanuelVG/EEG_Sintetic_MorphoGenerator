...
# Callback para actualizar la UI basada en el tipo de onda seleccionado
    ...
    def convert_stored_data_to_edf_format(stored_data):
        # Esta es una función de ejemplo, necesitas ajustarla según tu estructura de datos
    ...
    def save_data(n_clicks, stored_data):
        ...
        # Asume que save_to_txt maneja correctamente los arrays de NumPy o ajusta según sea necesario
    ...
    def save_data(n_clicks, amplitude_spike, amplitude_slow, duration_spike, duration_slow, amplitude_spike_slow, duration_spike_slow,
        ...
        for ch in range(n_channels):
            if wave_selector == "spike":
                ...
                # NOTA: Caso por defecto, es posible que se desee manejar esto de manera diferente a futuro
                channel_data = np.zeros(len(times))
