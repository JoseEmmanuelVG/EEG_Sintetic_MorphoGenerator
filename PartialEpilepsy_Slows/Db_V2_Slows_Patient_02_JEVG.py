...
event_channels_list = [
    ["Fp1", "F3", "F8", "T4", "T6", "O2"],
    ["Fp1", "F3", "F8", "T4", "T6", "O2"],
    ["T3", "T5", "O1", "C3", "P3", "F4", "C4", "P4", "F8", "T4", "T6", "O2"],
    ["T3", "T5", "O1", "C3", "P3", "F4", "C4", "P4", "F8", "T4", "T6", "O2"],
    ["T3", "T5", "O1"],
    ["T3", "T5", "O1"],
    ["F7", "T3", "T5", "F4", "C4", "F8", "T4", "T6", "O2"],
    ["F7", "T3", "T5", "F4", "C4", "F8", "T4", "T6", "O2"],
    ["T3", "T5", "F3", "C3", "F4", "C4", "P4", "F8", "T4", "T6"],
    ["T3", "T5", "F3", "C3", "F4", "C4", "P4", "F8", "T4", "T6"]
]
...
base_folder = Path("MonoEEG_Patient_2_Slows_JEVG")
index = 1
...
fif_filename = current_folder / "MonoEEG_Patient_2_Slows_JEVG_raw.fif"
...
txt_filename = current_folder / "MonoEEG_Patient_2_Slows_JEVG_text.txt"
...
edf_filename = current_folder / "MonoEEG_Patient_2_Slows_JEVG_EegFormat.edf"
...
for i in range(10):
    ...
    fig.savefig(current_folder / f'MonoEEG_Pat_2_Sl_JEVG_segment_{i+1}.jpg')
    plt.close(fig)
