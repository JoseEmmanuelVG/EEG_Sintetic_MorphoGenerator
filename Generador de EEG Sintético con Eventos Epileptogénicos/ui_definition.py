...
def generacion_rapida_layout():
    return html.Div([
        ...
        html.Br(), 
        html.Label('Number of Waves (Select an appropriate range for the 10s, otherwise the eeg signal will not be generated):'),  
        html.Br(), 
        dcc.RangeSlider(  # Modificado a RangeSlider para seleccionar un rango
            id='ondas-slider',
            min=0,
            max=100,
            value=[5, 10],  # Valor inicial del rango
...
html.Div(id='duration-div', children=[
    ...
    dcc.Slider(id='eeg-amplitude-slider', min=0, max=100, step=1, value=25),  
