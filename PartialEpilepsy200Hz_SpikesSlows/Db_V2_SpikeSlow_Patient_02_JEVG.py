...
event_channels_list = [
    ["Fp1", "F7", "T3", "T5", "F3", "C3", "P3", "F4", "C4", "T6", "O2"],
    ["Fp1", "F7", "T3", "T5", "F3", "C3", "P3", "F4", "C4", "T6", "O2"],
    ["Fp1", "F7", "T3", "T5", "F3", "C3", "P3", "F4", "C4", "T6", "O2"],
    ["Fp1", "F7", "T3", "T5", "F3", "C3", "P3", "F4", "C4", "T6", "O2"],
    ["Fp1", "F7", "T3", "T5", "F3", "C3", "P3", "F4", "C4", "T6", "O2"],
...
base_folder = Path("MonoEEG_Patient_2_Sp_Sl_JEVG")
index = 1
...
fif_filename = current_folder / "MonoEEG_Patient_2_Sp_Sl_JEVG_raw.fif"
...
txt_filename = current_folder / "MonoEEG_Patient_2_Sp_Sl_JEVG_text.txt"
...
edf_filename = current_folder / "MonoEEG_Patient_2_Sp_Sl_JEVG_EegFormat.edf"
...
for i in range(10):
    ...
    fig.savefig(current_folder / f'MonoEEG_Pat_2_SpSl_JEVG_segment_{i+1}.jpg')
    plt.close(fig)
