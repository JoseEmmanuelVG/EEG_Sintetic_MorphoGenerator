...
event_channels_list = [
    ["Fp1", "F7", "T3", "T5", "O1", "Fp1", "F3", "C3", "P3", "O1", "Fp2", "F4", "C4", "P4"],
    ["Fp1", "F7", "T3", "T5", "O1", "Fp1", "F3", "C3", "P3", "O1", "Fp2", "F4", "C4", "P4"],
    ["Fp1", "F7", "T3", "Fp1", "F3", "C3"],
    ["Fp1", "F7", "T3", "Fp1", "F3", "C3"],
    ["Fp1", "F7", "T3", "T5", "O1", "Fp1", "F3", "C3", "P3", "O1", "Fp2", "F4", "C4", "P4"],
    ["Fp1", "F7", "T3", "T5", "O1", "Fp1", "F3", "C3", "P3", "P3", "O1", "Fp2", "F4", "C4", "P4"],
    ["Fp1", "F7", "T3", "Fp1", "F3", "C3"],
    ["Fp1", "F7", "T3", "Fp1", "F3", "C3"],
    ["Fp1", "F7", "T3", "Fp1", "F3", "C3"],
    ["Fp1", "F7", "T3", "Fp1", "F3", "C3"]
...
base_folder = Path("MonoEEG_Patient_4_Slows_JEVG")
index = 1
...
fif_filename = current_folder / "MonoEEG_Patient_4_Slows_JEVG_raw.fif"
...
txt_filename = current_folder / "MonoEEG_Patient_4_Slows_JEVG_text.txt"
...
edf_filename = current_folder / "MonoEEG_Patient_4_Slows_JEVG_EegFormat.edf"
...
for i in range(10):
    ...
    fig.savefig(current_folder / f'MonoEEG_Pat_4_Sl_JEVG_segment_{i+1}.jpg')
    plt.close(fig)
