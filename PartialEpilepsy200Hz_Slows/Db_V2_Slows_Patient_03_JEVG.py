...
base_folder = Path("MonoEEG_Patient_3_Slows_JEVG")
index = 1
...
fif_filename = current_folder / "MonoEEG_Patient_3_Slows_JEVG_raw.fif"
...
txt_filename = current_folder / "MonoEEG_Patient_3_Slows_JEVG_text.txt"
...
edf_filename = current_folder / "MonoEEG_Patient_3_Slows_JEVG_EegFormat.edf"
...
for i in range(10):
    ...
    fig.savefig(current_folder / f'MonoEEG_Pat_3_Sl_JEVG_segment_{i+1}.jpg')
    plt.close(fig)
