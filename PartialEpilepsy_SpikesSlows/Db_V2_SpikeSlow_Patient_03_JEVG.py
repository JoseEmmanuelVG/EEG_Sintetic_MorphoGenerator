...
base_folder = Path("MonoEEG_Patient_3_Sp_Sl_JEVG")
index = 1
...
fif_filename = current_folder / "MonoEEG_Patient_3_Sp_Sl_JEVG_raw.fif"
...
txt_filename = current_folder / "MonoEEG_Patient_3_Sp_Sl_JEVG_text.txt"
...
edf_filename = current_folder / "MonoEEG_Patient_3_Sp_Sl_JEVG_EegFormat.edf"
...
for i in range(10):
    ...
    fig.savefig(current_folder / f'MonoEEG_Pat_3_SpSl_JEVG_segment_{i+1}.jpg')
    plt.close(fig)
